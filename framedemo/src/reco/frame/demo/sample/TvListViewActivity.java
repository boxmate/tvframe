...
import reco.frame.demo.adapter.TvListAdapter;
import reco.frame.demo.entity.AppInfo;
import reco.frame.tv.view.TvListView;
import reco.frame.tv.view.TvListView.OnItemClickListener;
import reco.frame.tv.view.TvListView.OnItemSelectListener;
import android.os.Bundle;
import android.util.Log;
import android.view.View;
import android.app.Activity;

public class TvListViewActivity extends Activity {
	...
	/**
	 * 初始加载45条数据 也可一次加载 1000+数据 TvListView最多加载总高度为屏幕高度2位的数据 无需担心溢出
	 * 光标移动到页尾时,将自动加载更多
	 */
	private void load() {
...
//		});
		...
		tlv_list.setOnItemSelectListener(new OnItemSelectListener() {

			@Override
			public void onItemSelect(View item, int position) {

				Log.i(TAG, "onItemSelect=" + position);
		...
		tlv_list.setOnItemClickListener(new OnItemClickListener() {
