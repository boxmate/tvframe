/**
 * Copyright (c) 2012-2013, Michael Yang ï¿½ï¿½ï¿½ï¿½ï¿½ã??ï¿½å?¤æ?·é??çª?ï¿½ï¿½ï¿½ç?½ï¿½ï¿½ï¿½ï¿½ï¿½???ï¿½ï¿½ï¿½é??ï¿? (www.yangfuhai.com).
 *
...
public class FileEntityHandler {
	...
	public Object handleEntity(Context appContext,HttpEntity entity, EntityCallBack callback,String target,boolean isResume) throws IOException {
		...
		while (!mStop && !(current >= count) && ((readLen = input.read(buffer,0,1024)) > 0) ) {//Î´È«²¿¶ÁÈ¡
		...
		if(mStop && current < count){ //ÓÃ»§Ö÷¶¯Í£Ö¹
