...
//					R.styleable.TvListView_boarderLeft, 1);
//			this.boarderTop = (int) custom.getDimension(
//					R.styleable.TvListView_boarderTop, 1);
//			this.boarderRight = (int) custom.getDimension(
//					R.styleable.TvListView_boarderRight, 1);
//			this.boarderBottom = (int) custom.getDimension(
//					R.styleable.TvListView_boarderBottom, 1);
//		} else {
...
//		int initLength = Math.min(adapter.getCount(), initRows * 3);
//		for (int i = 0; i < initLength; i++) {
//			int top = i * (spaceVert + itemHeight);
//			RelativeLayout.LayoutParams rlp = new RelativeLayout.LayoutParams(
//					itemWidth, itemHeight);
//			rlp.setMargins(paddingLeft, top, 0, 0);
...
//							flag = true;
//						}
//					} else if (nextIndex < selectIndex && nextIndex != 0) {
...
//			adapter.getView(position, getChildAt(position), TvListView.this);
//		}
//
//	}
//
